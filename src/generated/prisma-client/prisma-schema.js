...
input LinkCreateOneWithoutVoteInput {
...
input LinkCreateWithoutVoteInput {
  id: ID
  description: String!
  url: String!
  postedBy: UserCreateOneWithoutLinksInput
...
input LinkUpdateOneRequiredWithoutVoteInput {
  create: LinkCreateWithoutVoteInput
...
input LinkUpdateWithoutVoteDataInput {
  description: String
  url: String
  postedBy: UserUpdateOneWithoutLinksInput
}
...
input LinkUpsertWithoutVoteInput {
  update: LinkUpdateWithoutVoteDataInput!
  create: LinkCreateWithoutVoteInput!
}
